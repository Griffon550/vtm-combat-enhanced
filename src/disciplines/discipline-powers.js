...
const POTENCE = [
  {
    ...
    notes: 'Unbewaffnete Treffer zählen als aggravated. Passiv.',
  },
  {
    discipline: 'potence',
    level:      1,
  ...
  },
  {
    ...
    duration:   'scene',
    effect: {
      appliesTo:   ['attack_unarmed', 'attack_melee', 'attack_light', 'attack_heavy'],
      damageBonus: 'scale_with_rating',
    },
    notes: '+Potence-Rating Schaden auf Nahkampftreffer. Rouse Check.',
  },
  {
    discipline: 'potence',
    level:      3,
  ...
  },
  {
    ...
    duration:   'one_turn',
    effect: {
      statusApply:    ['enraged', 'destabilized'],
      requiresContest: true,
    },
    notes: 'Contest: STR+Potenz vs. STR+Athletik. Bei Erfolg: enraged + destabilized.',
  },
  {
    discipline: 'potence',
    level:      4,
  ...
  },
  {
    ...
    notes: '+4 Würfel + aggravated auf Faustkampf für eine Szene. Rouse Check.',
  },
  {
    discipline: 'potence',
    level:      5,
